...
export type LicensingAuthority = "MGA" | "UKGC" | "Gibraltar" | "Curacao" | "IsleOfMan" | "Kahnawake"
...
export interface Payments {
  ...
  fees: { deposits: "none" | "varies" | "fixed"; withdrawals: "none" | "varies" | "fixed" }
  currencies: Array<"EUR" | "USD" | "CAD" | "NZD" | "NOK" | "BTC" | "ETH" | "LTC">
}
...
export const TOP6_CASINOS_MOCK: Casino[] = [
  {
    ...
    licenses: [{ authority: "MGA", licenseId: "MGA/B2C/00123", validFrom: "2018-05-20" }],
    trust: {
      rating: 4.7,
      ...
      rgTools: ["deposit-limits", "cool-off", "self-exclusion", "reality-checks"],
    },
    bonuses: [
      {
        id: "aurora-welcome",
        ...
        value: { matchPercent: 100, maxAmount: 1000, currency: "EUR", spins: 100 },
        wagering: {
          x: 35,
    ...
    payments: {
      depositMethods: ["Visa", "Mastercard", "Skrill", "Neteller", "Trustly", "Paysafecard"],
      withdrawalMethods: ["Bank Transfer", "Skrill", "Neteller", "Trustly"],
      minDeposit: 10,
      minWithdrawal: 20,
    ...
    games: {
      total: 4500,
      liveDealer: 220,
      providers: ["NetEnt", "Microgaming", "Pragmatic Play", "Play'n GO", "Evolution", "BTG"],
      topTitles: ["Starburst", "Book of Dead", "Sweet Bonanza", "Gonzo's Quest Megaways"],
    },
    support: {
      liveChat: "24/7",
    ...
    review: {
      overallRating: 9.2,
      summary: "Balanced all-rounder with audited RTP, fair T&Cs, and speedy e-wallet payouts.",
      pros: ["Full RTP disclosure", "Fast e-wallet withdrawals", "Strong slot catalog"],
      cons: ["No crypto", "No phone support"],
      verdict: "Great for players who value trust and quick cashouts without sacrificing selection.",
  ...
  },
  {
    ...
    licenses: [{ authority: "Gibraltar", licenseId: "GIB-4567", validFrom: "2020-03-10" }],
    trust: {
      rating: 4.5,
    ...
    bonuses: [
      ...
      },
      {
        ...
        wagering: { x: 35, appliesTo: "bonus", maxBet: 3, excludedGames: [], expiryDays: 14 },
        minDeposit: 10,
        verifiedOn: "2025-08-15",
      },
    ],
    payments: {
      depositMethods: ["Visa", "Mastercard", "Skrill", "Neteller", "MiFinity", "Paysafecard"],
    ...
    games: {
      total: 5200,
      liveDealer: 260,
      providers: ["Pragmatic Play", "Play'n GO", "Relax", "Yggdrasil", "Evolution", "Hacksaw"],
      topTitles: ["Money Train 3", "Gates of Olympus", "Book of Dead", "Big Bass Bonanza"],
    },
    support: {
      liveChat: "24/7",
    ...
    review: {
      overallRating: 9.0,
      summary: "Massive promos and huge library; wagering is on the higher side.",
      pros: ["Very generous welcome", "Excellent game variety", "Crypto-friendly"],
      cons: ["Higher wagering (40x)", "Withdrawal fees may apply"],
      verdict: "Top pick if you chase big bonuses and variety and don’t mind extra wagering.",
      author: { name: "Editorial Team" },
  ...
  },
  {
    ...
    geo: { allowedCountries: ["NO", "SE", "FI", "DE"], restrictedCountries: ["UK", "US"] },
    licenses: [
      { authority: "MGA", licenseId: "MGA/B2C/00456", validFrom: "2016-11-01" },
      { authority: "IsleOfMan", licenseId: "IOM-7788", validFrom: "2019-07-15" },
    ],
    trust: {
      rating: 4.9,
      ...
      rtpTransparency: "FULL",
      rgTools: ["deposit-limits", "session-limits", "reality-checks", "self-exclusion"],
    },
    bonuses: [
      {
        id: "viking-cashback",
        ...
        wagering: { x: 1, appliesTo: "bonus", maxBet: 10, excludedGames: [], expiryDays: 7 },
        minDeposit: 20,
        verifiedOn: "2025-08-10",
      },
    ],
    payments: {
      depositMethods: ["Visa", "Mastercard", "Trustly", "Skrill", "Neteller"],
      withdrawalMethods: ["Trustly", "Skrill", "Neteller", "Bank Transfer"],
      minDeposit: 10,
      minWithdrawal: 20,
    ...
    games: {
      total: 4100,
      liveDealer: 180,
      providers: ["NetEnt", "Play'n GO", "Thunderkick", "Evolution", "BTG"],
      topTitles: ["Dead or Alive 2", "Reactoonz", "Jammin' Jars", "Temple Tumble"],
    },
    support: {
      liveChat: "24/7",
    ...
    review: {
      overallRating: 9.4,
      summary: "Nordic veteran with elite trust markers and near-instant Trustly withdrawals.",
      pros: ["Lowest complaint rate in set", "Instant Trustly payouts", "Transparent RTP"],
      cons: ["Smaller bonus emphasis", "No crypto"],
      verdict: "A go-to pick for players who value reliability and rapid payouts over flashy promos.",
      author: { name: "Editorial Team" },
      lastUpdated: "2025-09-01",
    },
    facts: [
  ...
  },
  {
    ...
    geo: { allowedCountries: ["CA", "NZ", "DE", "NO"], restrictedCountries: ["UK", "US"] },
    licenses: [{ authority: "Curacao", licenseId: "CUR-804/JA", validFrom: "2023-02-01" }],
    trust: {
      rating: 4.3,
    ...
    bonuses: [
      {
        ...
        value: { matchPercent: 200, maxAmount: 1500, currency: "CAD", spins: 150 },
        wagering: {
          x: 45,
          appliesTo: "bonus",
          maxBet: 5,
    ...
    payments: {
      depositMethods: ["Visa", "Mastercard", "Interac", "MuchBetter", "Crypto"],
    ...
    games: {
      total: 4800,
      liveDealer: 210,
      providers: ["Pragmatic Play", "Relax", "Evolution", "Play'n GO", "Hacksaw"],
      topTitles: ["The Dog House", "Money Train 2", "Wanted Dead or a Wild", "Big Bass Splash"],
    },
    support: {
    ...
    review: {
      overallRating: 8.7,
      summary: "Bonus-forward newcomer with big promos and broad payment coverage.",
      pros: ["Huge 200% welcome", "Interac for CA", "Solid game mix"],
      cons: ["Higher wagering (45x)", "Chat not truly 24/7"],
      verdict: "Compelling for bonus hunters in CA/NZ willing to accept steeper wagering.",
      author: { name: "Editorial Team" },
  ...
  },
  {
    ...
    geo: { allowedCountries: ["NO", "FI", "NZ"], restrictedCountries: ["UK", "US", "DE"] },
    licenses: [{ authority: "MGA", licenseId: "MGA/B2C/00999", validFrom: "2024-11-12" }],
    trust: {
      rating: 4.2,
      ...
      rtpTransparency: "PARTIAL",
      rgTools: ["deposit-limits", "loss-limits", "time-outs", "self-exclusion"],
    },
    bonuses: [
      {
        id: "pine-welcome",
        ...
        value: { matchPercent: 100, maxAmount: 800, currency: "EUR", spins: 200 },
        wagering: {
          x: 35,
          appliesTo: "deposit+bonus",
          maxBet: 5,
    ...
    games: {
      total: 4300,
      liveDealer: 170,
      providers: ["NetEnt", "Pragmatic Play", "NoLimit City", "Evolution"],
      topTitles: ["Fire in the Hole", "Starburst", "Sugar Rush", "Book of Dead"],
    },
    support: {
      liveChat: "24/7",
    ...
    review: {
      overallRating: 8.8,
      summary: "Fresh look, fair wagering, and strong slots lineup built for Nordics.",
      pros: ["Fair 35x wagering", "Nordic payment focus", "Polished UX"],
      cons: ["Lower daily withdrawal limit", "No crypto"],
      verdict: "A rising option in NO/FI with clean UX and a sensible welcome package.",
      author: { name: "Editorial Team" },
      lastUpdated: "2025-09-01",
    },
    facts: [
      { key: "launch_date", value: "2024-11-12", verifiedOn: "2025-08-01" },
      {
        key: "wagering",
  ...
  },
  {
    ...
    geo: { allowedCountries: ["NZ", "CA", "NO"], restrictedCountries: ["UK", "US", "DE", "FR"] },
    licenses: [{ authority: "Curacao", licenseId: "CUR-5566/SB", validFrom: "2021-08-05" }],
    trust: {
      rating: 4.1,
    ...
    payments: {
      depositMethods: ["Visa", "Mastercard", "Skrill", "Neteller", "Crypto"],
    ...
    games: {
      ...
      topTitles: ["Sugar Rush 1000", "Chaos Crew", "Money Train 4", "Sweet Bonanza"],
    },
    support: {
      liveChat: "24/7",
    ...
    review: {
      overallRating: 8.5,
      summary: "Lightning-fast crypto cashouts with a decent mix of high-volatility slots.",
      pros: ["Crypto instant payouts", "High daily withdrawal cap", "Good volatility variety"],
      cons: ["No RTP transparency", "Curacao-only license"],
      verdict: "Best suited to crypto-first players prioritizing speed over transparency depth.",
      author: { name: "Editorial Team" },
      lastUpdated: "2025-09-02",
    },
    facts: [
